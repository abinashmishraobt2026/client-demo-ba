...
import { getUser, isAuthenticated, isAdmin, isAssociate } from '../../utils/auth';
...
const ChangePassword = () => {
  ...
  if (!isAssociate() || !getUser()) return null;
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-orange-400 to-yellow-500 flex items-center justify-center p-4">
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-900">Please set your new password</h1>
          <p className="text-gray-600 mt-1 text-sm">
            Enter your new password below. It will be saved and used for your next login.
          </p>
        </div>
